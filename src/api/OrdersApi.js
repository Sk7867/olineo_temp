...
export const getIndiOrder = async (id) => {
  ...
  await axios.get(`${process.env.REACT_APP_BASE_URL}/product/order/details/${id}`, {}, { headers }).then((res) => {
...
export const cancelOrder = async (order_Id, itemId, query) => {
  ...
  await axios.delete(`${process.env.REACT_APP_BASE_URL}/product/order/${order_Id}`, { headers, data }).then((res) => {
